            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-warning">
                        ...
                        <a href="{{ route('admin.projects.index', ['status' => 'pending']) }}?status=pending"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="list-group">
                                ...
                                <a href="{{ route('admin.defenses.create') }}"
                                    class="list-group-item list-group-item-action">
                                    <i class="fas fa-plus-circle me-2"></i> Programmer une soutenance
                                </a>
                            </div>
                        </div>
                    </div>
