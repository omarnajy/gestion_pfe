                                        ...
                                        <div class="card border-0 shadow-sm">
                                            ...
                                            <div class="card-body p-0">
                                                <table class="table table-hover mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <th style="width:35%" class="ps-3">{{ __('Étudiant') }}</th>
                                                            <td>
                                                                @if($project->student)
                                                                    <a href="{{ route('admin.users.show', $project->student_id) }}" class="text-decoration-none">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @php
                                                                    ...
                                                                    elseif ($project->student && isset($project->student->assignments) && $project->student->assignments) {
                                                                        $assignment = $project->student->assignments;
                                                                        if ($assignment && isset($assignment->supervisor_id)) {
                                                                ...
                                                                @if($supervisor)
                                                                    <div class="d-flex align-items-center">
                                                                        <a href="{{ route('admin.users.show', $supervisorId) }}" class="text-decoration-none me-2">
                                                                ...
                                                                @else
                                                                    <div class="d-flex align-items-center">
                                                                        <span class="text-muted me-2">{{ __('Non assigné') }}</span>
                                                                        <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#assignSupervisorModal">
                                                                            <i class="fas fa-plus-circle me-1"></i> {{ __('Assigner') }}
                                                                        </button>
                                                                    </div>
                                                                @endif
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-danger">{{ $project->rejection_reason }}</td>
                                                        </tr>
                                                        @endif
                                                    </tbody>
                                                </table>
                            ...
                            <div class="card shadow-sm border-0 mb-4">
                                ...
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        <a href="{{ route('admin.documents', ['project_id' => $project->id]) }}" class="btn btn-outline-primary">
                                        ...
                                        <form action="{{ route('admin.projects.approve', $project->id) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-success w-100">
                                                <i class="fas fa-check-circle me-1"></i> {{ __('Approuver le projet') }}
                                            </button>
                                        </form>
                                        
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#rejectProjectModal">
                                            <i class="fas fa-times-circle me-1"></i> {{ __('Refuser le projet') }}
                                        </button>
                                        @endif
                                        
                                        @if(!$supervisor)
                                        <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#assignSupervisorModal">
