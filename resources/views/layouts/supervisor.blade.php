...
<head>
    ...
    <style>
        ...
        .bg-warning .small-box-footer, .bg-danger .small-box-footer {
            color: #fff !important;
        }
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('supervisor.projects.index') }}" class="nav-link {{ request()->is('supervisor/projects*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-project-diagram"></i>
                            <p>Projets</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('supervisor.students.index') }}" class="nav-link {{ request()->is('supervisor/students*') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-user-graduate"></i>
                            <p>Étudiants</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('supervisor.profile') }}" class="nav-link {{ request()->is('supervisor/profile') ? 'active' : '' }}">
                            <i class="nav-icon fas fa-user-graduate"></i>
                            <p>Profile</p>
                        </a>
                    </li>
