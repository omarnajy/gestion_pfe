    ...
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-8">
                ...
                <p class="text-muted">Parcourez les sujets proposés par les encadreurs et choisissez celui qui vous
                    intéresse.</p>
            </div>
                ...
                @forelse($projects as $project)
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8">
                                    <h6 class="card-subtitle mb-2 text-muted">Proposé le
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <ul class="list-unstyled">
                                                <li><i class="fas fa-user-tie me-2"></i> <strong>Encadreur :</strong>
                                                    {{ $project->supervisor->name }}</li>
                                                <li><i class="fas fa-graduation-cap me-2"></i> <strong>Département
                                                        :</strong> {{ $project->supervisor->department ?? 'Non spécifié' }}
                                                </li>
                                                <li><i class="fas fa-calendar-alt me-2"></i> <strong>Date de proposition
                                                        :</strong> {{ $project->created_at->format('d/m/Y') }}</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <p><strong>Département :</strong>
                                            {{ $project->supervisor->department ?? 'Non spécifié' }}</p>
                                        <p><strong>Spécialité :</strong>
                                            {{ $project->supervisor->specialty ?? 'Non spécifiée' }}</p>
                                    </div>

                                    <div class="mb-4">
                                        <h6 class="text-primary">Détails techniques</h6>
                                        <p><strong>Technologies :</strong>
                                            {{ $previousProject->technologies ?? 'Non spécifiées' }}
                                        </p>
                                    </div>
                                        ...
                                        <form action="{{ route('student.projects.apply', $project->id) }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="motivation" name="motivation" rows="4" required
                                                    placeholder="Expliquez pourquoi vous êtes intéressé par ce projet et pourquoi vous seriez un bon candidat..."></textarea>
                                            </div>
