            ...
            <div class="col-md-4 mb-4">
                <div class="card role-card" onclick="window.location.href='{{ route('login.form', 'student') }}'">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Accéder à votre espace étudiant pour gérer votre projet de fin d'études.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card role-card" onclick="window.location.href='{{ route('login.form', 'supervisor') }}'">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Accéder à votre espace encadreur pour superviser les projets de vos étudiants.</p>
                    </div>
                </div>
            </div>
