...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#proposeProjectModal">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-tabs mb-4" id="projectTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending"
                                    ...
                                    En attente <span
                                        class="badge bg-warning rounded-pill">{{ $pendingProjects->count() }}</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="validated-tab" data-bs-toggle="tab" data-bs-target="#validated"
                                    type="button" role="tab" aria-controls="validated" aria-selected="false">
                                    Validés <span
                                        class="badge bg-success rounded-pill">{{ $validatedProjects->count() }}</span>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="rejected-tab" data-bs-toggle="tab" data-bs-target="#rejected"
                                    ...
                                    Rejetés <span
                                        class="badge bg-danger rounded-pill">{{ $rejectedProjects->count() }}</span>
                                </button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content" id="projectTabsContent">
                            <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                                @include('supervisor.projects.partials.projects-table', [
                                    'projects' => $projects,
                                ])
                            </div>
    ...
    <div class="modal fade" id="proposeProjectModal" tabindex="-1" aria-labelledby="proposeProjectModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="{{ route('supervisor.projects.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="title" class="form-label">Titre du projet <span
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="technology" name="technology"
                                    placeholder="Ex: Laravel, React, TensorFlow...">
                            </div>
                        </div>
