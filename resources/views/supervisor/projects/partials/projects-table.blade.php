@if($projects->count() > 0)
            ...
            @endif
                    ...
                    <td>
                        <div class="btn-group" role="group">
                            <a href="{{ route('supervisor.projects.show', $project->id) }}" class="btn btn-sm btn-primary">
                            ...
                            <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#rateModal{{ $project->id }}">
    ...
    @foreach($projects as $project)
        ...
        <!-- Rate Modal -->
        <div class="modal fade" id="rateModal{{ $project->id }}" tabindex="-1" aria-labelledby="rateModalLabel{{ $project->id }}" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
