    ...
    <div class="col-md-7">
        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex justify-content-between align-items-center bg-warning text-dark">
                ...
                <span class="badge bg-dark">{{ $pendingProjects ?? 0}}</span>
            </div>
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('supervisor.projects.show', $project->id) }}">{{ $project->title }}</a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('supervisor.projects.show', $project->id) }}" class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-outline-success" data-bs-toggle="modal" data-bs-target="#validateModal{{ $project->id }}">
        ...
        <!-- Mes statistiques (remplace la section "Projets en cours") -->
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="mb-2 small text-muted">
                                    <i class="fas fa-file-alt me-1"></i> Projet: <strong>{{ $comment->project->title }}</strong>
                                </p>
                                <div class="comment-content border-start border-primary ps-2 mt-2">
                                    <p class="mb-0">{{ Str::limit($comment->content, 150) }}</p>
                                </div>
                                <div class="text-end mt-2">
                                    <a href="{{ route('supervisor.projects.show', $comment->project_id) }}" class="btn btn-sm btn-outline-primary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var projectsChart = new Chart(ctx, {
            type: 'doughnut',
            data: {
                labels: ['En attente', 'En cours','Rejetés'],
                datasets: [{
                    data: [
