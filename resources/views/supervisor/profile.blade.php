    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('supervisor.profile.edit') }}" class="btn btn-tool">
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                <th>Numéro d'encadrant</th>
                                <td>{{ $user->supervisor_id ?? 'Non défini' }}</td>
                            </tr>
                            <tr>
                                <th>Département</th>
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('supervisor.update-password') }}" method="POST">
                        @csrf
                        @method('PUT')
